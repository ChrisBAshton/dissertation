...
Cloud computing as a web hosting service is becoming increasingly popular, Amazon Web Services (AWS) chief amongst these in terms of exponential growth [REF]. AWS is being utilised by companies including the BBC, [REF] its popularity down to its speed and scalability, as well as the low cost to market. %http://www.bbc.co.uk/news/business-32442268
...
\begin{figure}[h!]
  \centering
    \ifimages
    \includegraphics[width=\textwidth]{screenshot--smartresolution_org}
    \fi
