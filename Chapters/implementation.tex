...
\begin{figure}[h!]
  \centering
    \ifimages
    \includegraphics[width=\textwidth]{smartresolution--mobile}
    \fi
...
@TODO  Describe why this was a requirement for the website, but not for the core software.

@TODO - describe the video and why it was made. Also - music for the video? mention in credits? % http://soundimage.org/looping-music/ ``GAME MENU_v001 - A looping version of the original."
