...
@TODO - remove this footnote. Probably best to move to a dedicated section where all relevant links live, e.g. smartresolution.org, marketplace, core software, module, documentation, and so on. Not the annotated bibliography.

This module is separate from the core platform and lives in its own repository\footnote{\url{https://github.com/ChrisBAshton/smartresolution-module-maritime-collision}}. It can be manually installed to any SmartResolution installation simply by being copied to the \lstinline{modules} directory, or automatically installed through the SmartResolution Marketplace facility.
