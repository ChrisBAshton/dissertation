...
The choice of license for each component highlights how distinct each component is from one another.
...
Other integrity constraints exist, such as `organisations.type' only being one of ``law_firm" or ``mediation_centre". These have been omitted from the diagram.
