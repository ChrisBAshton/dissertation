...
@TODO - this is a lie - the config.json file also needs updating. Need to add a graph somewhere to visualise how a module is pulled into the system.
...
@TODO - show how config.json is used.
