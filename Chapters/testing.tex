...
Inside Dispute, we had something like this:
...
I stated earlier that I managed to run 112 unit tests in 34 seconds (3.29 UTPS) as a result of minimising the number of times I had to clear the database in between each test or test suite. Changing object constructors to take arrays rather than database record IDs meant I could cut down this figure even further. After implementing the refactored solution, my test suite performed 109 unit tests in just 12.7 seconds: a UTPS of 8.57. It is worth noting that those are the results on Travis: on my MacBook Pro, unit tests run in under six seconds. %https://travis-ci.org/ChrisBAshton/smartresolution/builds/59532839
